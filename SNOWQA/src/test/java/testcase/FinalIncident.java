...
public void testCreateStandAloneIncidentTicket() throws Exception{
		...
		String incNumber = IncidentReusables.createstandaloneincident1(driver, 1, 2);
	...
	@Test(priority=1,description="Reject CR ticket",enabled=true)
	...
	@Test(priority=2,description="Reject CR ticket",enabled=true)
